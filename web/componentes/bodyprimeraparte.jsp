            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Ver Odontólogos</a><!-- cambiamos el nombre, se deja entre comillas por que ahi van especificado la ruta de nuestro jsp,que aun no se a creado -->
                        <a class="collapse-item" href="altaOdontologo.jsp">Alta Odontólogos</a> <!-- vamos a crear en la tercera entrega el formulario, tambien se colocara en referencia altaOdontologo.jsp para que lo pueda asignar  -->
                    </div>
                </div>
            </li>
            ...
            <!-- copiamos la parte del codigo para agregar el metodo de usuarios -->
             <li class="nav-item">
                ...
                <div id="collapseUser" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"> <!-- se tiene que tener en cta cuando copiamos debemos de cambiar el direccionamiento del codigo se cambia a uno nuevo <div id="collapseUser" y tmb data-target="#collapseUser" debe de ser el mismo-->
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6><!-- cambiamos el nombre a acciones --> 
                        <a class="collapse-item" href="">Ver Usuarios</a><!-- cambiamos el nombre, se deja entre comillas por que ahi van especificado la ruta de nuestro jsp,que aun no se a creado -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Giovanna López</span>
